 ...
 */
public abstract class BaseActivity<DataBinding extends ViewDataBinding> extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (layout != null) {
            ...
            titleView = (TextView) findViewById(R.id.actionbarTitle);
            if (titleView != null) {
        ...
        if (translucentAnnotation != null && translucentAnnotation.value()) {
            ...
            if (autoChangeStatusBar) {
                ...
                if (support) {
                    ...
                    rootView.setBackgroundColor(getResources().getColor(R.color.nhs_bg_black));
                }
            }
        }
    }
